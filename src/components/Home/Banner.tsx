...
function Banner() {
  return (
    <section className="md:mb-10 flex w-full flex-col items-center justify-start gap-5 text-white mx-auto">
      <div className="relative flex w-full h-[600px] flex-col items-center justify-start gap-5 p-10 md:p-20">
        ...
        <Image src={ RankImage } alt="Rank Image" width={ 1600 } height={ 600 } className="w-full h-full object-cover absolute top-0 left-0 -z-10" />
      </div>
    </section>
  );
}
